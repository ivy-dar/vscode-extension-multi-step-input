 ...
 */
export async function multiStepInputNewProject(_context: ExtensionContext) {
	...
	const title = 'Create New Axon Ivy Project';
	...
	window.showInformationMessage(
		`Creating Project with name '${state.projectName}' and ID '${state.projectId}' in group '${state.groupId}'`,
	);
}
